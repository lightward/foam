...
- `bridges/` (+Mathlib, *not* axiom-free) — : Audit Closure Collapse Continuum Counter Duality Encounter HalfTurn HalfType Handedness Maschke Match Observation Quarter SeatTime Stagecraft Summit
