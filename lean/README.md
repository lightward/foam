...
| `toAlgebraic_ne_toAlgebraic'_plus` | the two orientations genuinely differ on `+` — the within-pair gauge-orientation is a free choice, held open (bias-delegation) |
